            ...
            is PreferencesUISideEffect.LoadPreferences -> {
                combine(
                    ...
                    PreferencesUICommand.PreferencesLoaded(
                        ...
                        showLogDate = showFirst[0],
                        showLogTime = showFirst[1],
                        showLogUid = showFirst[2],
                        showLogPid = showFirst[3],
                        showLogTid = showFirst[4],
                        showLogPackage = showSecond[0],
                        showLogTag = showSecond[1],
                        showLogContent = showSecond[2],
